...
```{r set_par, echo=FALSE, include=FALSE}
...
```{r numcore_lib, echo=FALSE, include=FALSE}
...
```{r reset_par, echo=FALSE, include=FALSE}
par(old_par)
```
...
- Q. Wang, J Armenia, C. Zhang, A.V. Penson, E. Reznik, L. Zhang, T. Minet, A. Ochoa, B.E. Gross, C. A. Iacobuzio-Donahue, D. Betel, B.S. Taylor, J. Gao, N. Schultz. Unifying cancer and normal RNA sequencing data from different sources. Scientific Data 5:180061, 2018. [Link](https://www.nature.com/articles/sdata201861).

- Fouodo, C. J. K., Kapar J., Huels A., Liang D., Wright M. N. Adversarial random forests for omics synthesis, 2026 bioRxiv preprint doi: https://doi.org/10.64898/2026.09.09.750490, [Link](https://doi.org/10.64898/2026.09.09.750490).

- Watson, D. S., Blesch, K., Kapar, J. & Wright, M. N. (2023). Adversarial random forests for density estimation and generative modeling. In Proceedings of the 26th International Conference on Artificial Intelligence and Statistics.  [Link](https://proceedings.mlr.press/v206/watson23a.html).
